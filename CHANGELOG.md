...
- 5ec1211: Allow repository-rule validation on `main` to ignore generated merge commits while
  continuing to validate every pull-request commit.
- c3401d1: Complete the shared Jenkins and Changesets release lifecycle and require Home Assistant 2026.7.0.
- cefb783: Migrate Jenkins to the shared Python 3.14 Home Assistant integration CI image and one
  per-build virtual environment.
