...
`CONTRIBUTING.md`. Jenkins validates those commits on the pull request. A merge commit
generated by GitHub is exempt on `main`, because it only wraps commits that were already
